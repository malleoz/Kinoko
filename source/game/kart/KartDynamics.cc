...
/// @stage All
/// @brief Every frame, computes acceleration, velocity, and position of the kart.
/// @addr{0x805B5170}
...
/// @stage All
/// @brief Each frame, stabilizes the bike by rotating towards the y-axis unit vector.
/// @addr{0x805B6448}
