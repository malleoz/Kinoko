...
/// @stage 2
/// @brief Each frame, checks for hop. Computes hop direction based on player input.
/// @addr{0x8057E804}
/// @return Whether or not we are hopping.
...
/// @stage All
/// @brief Every frame when touching ground and not drifting, clears drift state.
/// @addr{0x8057EA50}
