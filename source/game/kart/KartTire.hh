...
class KartTire {
public:
    KartTire(MirroredTire mirroredTire, u16 bspWheelIdx);
    virtual ~KartTire();
...
public:
    KartTireFront(MirroredTire mirroredTire, u16 bspWheelIdx);
    ~KartTireFront();
...
public:
    KartTireFrontBike(MirroredTire mirroredTire, u16 bspWheelIdx);
    ~KartTireFrontBike();
...
public:
    KartTireRearBike(MirroredTire mirroredTire, u16 bspWheelIdx);
    ~KartTireRearBike();
