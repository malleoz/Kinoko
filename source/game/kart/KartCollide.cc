...
/// @addr{0x805B6724}
/// @details On collision occurence, saves the appropriate information to the CollisionGroup's
/// CollisionData. Additionally may apply a change in position for certain KCL types.
/// @param totalScale
/// @param rot
/// @param scale
...
/// @param colVel The wheel's velocity. In the base game, it is always {0, -10.3f, 0}
...
/// @stage All
/// @brief Calculates the floor KCL's effect on the player's speed and handling.
/// @addr{0x8056EA04}
/// @param collisionData Stores the resulting speed and handling info
/// @param maskOut Stores the flags from the floor KCL
/// @param wheel Differentiates between kart and body floor collision (boost panels)
...
/// @stage 2
/// @brief Saves velocity and position info when vehicle body collision occurs
/// @addr{0x805B6D48}
