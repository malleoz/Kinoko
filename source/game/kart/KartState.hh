...
#include "game/kart/KartStatus.hh"
...
public:
    ...
    [[nodiscard]] bool isDrifting() const {
        return m_status.onBit(eKartStatus::DriftManual, eKartStatus::DriftAuto);
    }
    ...
    [[nodiscard]] KartStatus &status() {
        return m_status;
    }

    [[nodiscard]] const KartStatus &status() const {
        return m_status;
    }
