...
void KartSub::calcMovingObj() {
    if (_44 == 0) {
        ...
        m_roadVelocity *= 1.0f / static_cast<f32>(m_floorCollisionCount);
        physics()->composeMovingObjVel(m_roadVelocity, 0.2f);
    }
}
