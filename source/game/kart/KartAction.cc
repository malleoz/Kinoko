...
void KartAction::startAction5() {
    ...
    FUN_80568794(EXT_VEL_SCALAR, EXT_VEL_KART, EXT_VEL_BIKE, NUM_ROTATIONS, 2);
}
...
bool KartAction::calcAction14() {
    ...
    bool actionEnd = m_frame > m_crushTimer;
...
/// @addr{0x80569AD0}
void KartAction::endAction14(bool /*arg*/) {
    state()->setUNK20000(false);
}
