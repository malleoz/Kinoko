...
private:
    ...
    [[nodiscard]] f32 calcStepFactor(u32 t);
    [[nodiscard]] f32 calcSpeed(u32 t);
    ...
    const std::array<u32, 2> m_dirChangeFrames; ///< When escalators change direction (two times)
    ...
    const std::array<f32, 2> m_startFrames;     ///< When the escalator comes to a standstill
