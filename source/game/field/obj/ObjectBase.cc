...
ObjectBase::ObjectBase(const char *objName, const EGG::Vector3f &pos, const EGG::Vector3f &rot,
    ...
    : m_drawMdl(nullptr) {
    m_resFile = nullptr;
    m_id = ObjectDirector::Instance()->flowTable().getIdFromName(objName);
    m_mapObj = nullptr;
...
/// @addr{0x806B46A4}
EGG::Matrix34f ObjectBase::FUN_806B46A4(RailInterpolator *railInterpolator) {
    EGG::Matrix34f mat = FUN_806B3CA4(railInterpolator->curTangentDir());
