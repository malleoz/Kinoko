...
ObjectVolcanoPiece::ObjectVolcanoPiece(const System::MapdataGeoObj &params)
    : ObjectKCL(params), m_colMgrB(nullptr), m_colMgrC(nullptr) {
    m_initialPos = m_pos;
    m_initialRot = m_rot;

    snprintf(m_modelName, sizeof(m_modelName), "VolcanoPiece%d",
            static_cast<s32>(params.setting(0)));
...
bool ObjectVolcanoPiece::checkPointPartial(const EGG::Vector3f &v0, const EGG::Vector3f &v1,
    ...
    if (state == State::Rest) {
        return m_objColMgr->checkPointPartial(v0, v1, flags, pInfo, pFlagsOut);
    }

    bool colliding = m_objColMgr->checkPointPartial(v0, v1, flags, pInfo, pFlagsOut);

    if (!colliding && m_colMgrB) {
...
bool ObjectVolcanoPiece::checkPointPartialPush(const EGG::Vector3f &v0, const EGG::Vector3f &v1,
    ...
    if (state == State::Rest) {
        return m_objColMgr->checkPointPartialPush(v0, v1, flags, pInfo, pFlagsOut);
    }
...
bool ObjectVolcanoPiece::checkSpherePartial(f32 radius, const EGG::Vector3f &v0,
    ...
    if (state == State::Rest) {
        return m_objColMgr->checkSpherePartial(radius, v0, v1, flags, pInfo, pFlagsOut);
    }
...
bool ObjectVolcanoPiece::checkSpherePartialPush(f32 radius, const EGG::Vector3f &v0,
    ...
    if (state == State::Rest) {
        return m_objColMgr->checkSpherePartialPush(radius, v0, v1, flags, pInfo, pFlagsOut);
    }
...
bool ObjectVolcanoPiece::checkPointCachedPartial(const EGG::Vector3f &v0, const EGG::Vector3f &v1,
    ...
    if (state == State::Rest) {
        return m_objColMgr->checkPointCachedPartial(v0, v1, flags, pInfo, pFlagsOut);
    }
...
bool ObjectVolcanoPiece::checkPointCachedPartialPush(const EGG::Vector3f &v0,
    ...
    if (state == State::Rest) {
        return m_objColMgr->checkPointCachedPartialPush(v0, v1, flags, pInfo, pFlagsOut);
    }
...
bool ObjectVolcanoPiece::checkSphereCachedPartial(f32 radius, const EGG::Vector3f &v0,
    ...
    if (state == State::Rest) {
        return m_objColMgr->checkSphereCachedPartial(radius, v0, v1, flags, pInfo, pFlagsOut);
    }
...
bool ObjectVolcanoPiece::checkSphereCachedPartialPush(f32 radius, const EGG::Vector3f &v0,
    ...
    if (state == State::Rest) {
        return m_objColMgr->checkSphereCachedPartialPush(radius, v0, v1, flags, pInfo, pFlagsOut);
    }
...
/// @addr{0x808187B4}
const EGG::Matrix34f &ObjectVolcanoPiece::calcShakeAndFall(EGG::Vector3f *unknown, u32 timeOffset) {
