...
/// whether it is push (push entry in the CollisionDirector).
/// @param push Whether to push a collision entry
bool ObjectAmi::checkSpherePartialImpl(f32 radius, const EGG::Vector3f &v0,
        const EGG::Vector3f & /*v1*/, KCLTypeMask flags, CollisionInfoPartial *pInfo,
...
/// whether it is push (push entry in the CollisionDirector).
/// @param push Whether to push a collision entry
bool ObjectAmi::checkSphereFullImpl(f32 radius, const EGG::Vector3f &v0,
